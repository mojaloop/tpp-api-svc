...
const forwardTppConsentRequest = async (path, headers, method, params, payload, span = null) => {
  ...
  try {
    ...
    await forwardTppConsentRequestError(headers, source, Enum.EndPoints.FspEndpointTemplates.TPP_CONSENT_REQUESTS_PUT_ERROR, Enum.Http.RestMethods.PUT, consentRequestId, fspiopError.toApiErrorObject(Config.ERROR_HANDLING), childSpan)
    throw fspiopError
  } finally {
