...
module.exports = {
  ...
  post: async (context, request, h) => {
    ...
    try {
      ...
      tppConsentRequest.forwardTppConsentRequest(Enum.EndPoints.FspEndpointTemplates.TPP_CONSENT_REQUESTS_POST, request.headers, Enum.Http.RestMethods.POST, request.params, request.payload, span).catch(err => {
