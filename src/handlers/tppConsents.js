...
module.exports = {
  ...
  post: async (context, request, h) => {
    ...
    try {
      ...
      tppConsents.forwardTppConsents(tppConsents.EndpointPaths.TPP_CONSENTS_POST, request.headers, Enum.Http.RestMethods.POST, request.params, request.payload, span).catch(err => {
