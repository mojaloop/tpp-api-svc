...
module.exports = {
  ...
  post: async (context, request, h) => {
    ...
    try {
      ...
      tppAccountRequest.forwardTppAccountRequest(Enum.EndPoints.FspEndpointTemplates.TP_ACCOUNT_REQUEST_POST, request.headers, Enum.Http.RestMethods.POST, request.params, request.payload, span).catch(err => {
