...
module.exports = {
   ...
   */
  post: async (context: any, request: TraceableRequest, h: ResponseToolkit) => {
    ...
    try {
      ...
      tppConsentRequests.forwardTppConsentRequests(Enum.EndPoints.FspEndpointTemplates.TPP_CONSENT_REQUEST_POST, request.headers, Enum.Http.RestMethods.POST, request.params, request.payload, span).catch((err: Error) => {
