...
const tppAuthorizations = require('../../domain/tppAuthorizations')
const LibUtil = require('../../lib/util')

/**
 * Operations on /tppAuthorizations/{ID}
 */
module.exports = {
  /**
   * summary: tppGetAuthorizationsById
   * description: The GET /tppAuthorizations/{ID} is used to request the status of a previously sent authorization request. The result is returned via the PUT /tppAuthorizations/{ID} callback.
   * parameters: accept
  ...
  get: async (context, request, h) => {
    const histTimerEnd = Metrics.getHistogram(
      'tpp_authorizations_get',
      'Get tpp authorizations by Id',
      ['success']
    ).startTimer()
