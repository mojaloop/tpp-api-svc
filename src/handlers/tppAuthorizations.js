...
/**
 * Operations on /tppAuthorizations
 */
module.exports = {
  /**
   * summary: tppPostAuthorizations
   * description: The HTTP request POST /tppAuthorizations is used to request the validation by a customer for the transfer described in the request.
  ...
  post: async (context, request, h) => {
    const histTimerEnd = Metrics.getHistogram(
      'tpp_authorizations_post',
      'Post tpp authorizations request',
      ['success']
    ).startTimer()
