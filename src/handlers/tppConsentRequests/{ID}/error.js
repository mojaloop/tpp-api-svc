...
module.exports = {
  ...
  put: async (context, request, h) => {
    ...
    try {
      ...
      tppConsentRequests.forwardTppConsentRequest(Enum.EndPoints.FspEndpointTemplates.TPP_CONSENT_REQUEST_PUT_ERROR, request.headers, Enum.Http.RestMethods.PUT, request.params, request.payload, span).catch(err => {
