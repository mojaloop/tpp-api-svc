...
describe('PUT /tppConsents/{ID}', () => {
  ...
  const url = '/tppConsents/12345678-1234-4abc-9abc-123456789012'
  ...
  it('returns 400 when credentialType is not in the allowed enum', async () => {
    const response = await server.inject({
      method: 'PUT',
      url,
      headers: validHeaders,
