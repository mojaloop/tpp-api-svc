...
- [Technical Onboarding](./Technical-Onboarding.md)
  - [GitHub Repositories](./Technical-Onboarding.md#1-github-repositories)
  - [Issues and Board](./Technical-Onboarding.md#2-issues-and-board)
  - [Setting Up Local Development Tools and Environment](./Technical-Onboarding.md#3-setting-up-local-development-tools-and-environment)

## 2. Communication Onboarding

How to reach the workstream — meetings and Slack channels.

- [Communication Onboarding](./Communication-Onboarding.md)
  - [Workstream Meeting](./Communication-Onboarding.md#1-workstream-meeting)
  - [Slack Channels](./Communication-Onboarding.md#2-slack-channels)
